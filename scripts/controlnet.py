...
class Script(scripts.Script, metaclass=(
    ...
    def ui(self, is_img2img):
        ...
        controls = ()
        max_models = shared.opts.data.get("control_net_max_models_num", 5)
...
def on_ui_settings():
    ...
    shared.opts.add_option("control_net_max_models_num", shared.OptionInfo(
        3, "Multi ControlNet: Max models amount (requires restart)", gr.Slider, {"minimum": 5, "maximum": 10, "step": 1}, section=section))
